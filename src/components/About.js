    ...
    return (
        ...
        <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            Hey there, I'm Jimmy Walker, a self-taught and motivated web developer specializing in front-end development. With a solid grasp of HTML, CSS, and Javascript, I'm passionate about creating captivating online experiences. Let's bring your digital vision to life!
            </p>
